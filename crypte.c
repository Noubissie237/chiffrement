...
void crypte(char *fich1, char *fich2)
{
    ...
    printf("Entrez le mot de passe du chiffrement : ");
    scanf("%s",pass);
...
int main(int argc, char *argv[])
{
    ...
    printf("Etes vous sûr de vouloir crypter le fichier %s ? \n",argv[1]);
    printf("\t1. Oui\n");
    printf("\t2. Annuler\n");
    printf("choix : ");
    scanf("%d",&choix);
    ...
    switch(choix)
    {
        case 1 : 
            ...
            crypte(argv[1], argv[2]); break;
        
        case 2 : 

            printf("Chiffrement annule !!! \n"); break;
